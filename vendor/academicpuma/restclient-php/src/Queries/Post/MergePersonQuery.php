...
/**
 * Query for a request to merge a PersonUtils
 * @package AcademicPuma\RestClient\Queries\Post
 * @author kchoong
 */
class MergePersonQuery extends AbstractQuery
{

    /**
     * The query constructor builds the url and saves it into the url property.
     * The query is to merge a single person specified by their person id.
     *
