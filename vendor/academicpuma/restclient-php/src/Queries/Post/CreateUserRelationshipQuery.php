 ...
 */
class CreateUserRelationshipQuery extends AbstractQuery
{
     ...
     *
     * @param User $sourceUser create relation from this user
     * @param User $targetUser create relation to this user
     * @throws DOMException
     */
    public function __construct(User $sourceUser, User $targetUser)
    {
        ...
        $this->body = $xmlRenderer->render($targetUser);
    }
