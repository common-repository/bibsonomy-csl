...
/**
 * Builds URL for GetOrganizationDetails REST-API calls.
 * Also holds the response after being executed.
 *
 * @author kchoong
 */
class GetOrganizationDetailsQuery extends AbstractQuery
{

    /**
     * The query constructor builds the url and saves it into the url property.
     * The query is to get details of a single organization specified by their name.
     *
