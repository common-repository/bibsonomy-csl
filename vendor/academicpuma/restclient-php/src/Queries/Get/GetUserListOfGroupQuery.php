 ...
 */
class GetUserListOfGroupQuery extends AbstractQuery
{
     ...
     *
     * @param string $groupname name of the group to receive userlist from
     * @param int $start start index
     * @param int $end end index
     */
    public function __construct(string $groupname, int $start, int $end)
    {
        parent::__construct();
