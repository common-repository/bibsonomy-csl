...
/**
 * Query for a request to get a list of Relations of a PersonUtils
 * @package AcademicPuma\RestClient\Queries\Get
 * @author kchoong
 */
class GetPersonListOfRelationsQuery extends AbstractQuery
{

    /**
     * The query constructor builds the url and saves it into the url property.
     * The query is to get the relations of a single person specified by their person id.
     *
