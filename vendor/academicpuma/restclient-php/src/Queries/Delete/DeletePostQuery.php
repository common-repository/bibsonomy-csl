...
class DeletePostQuery extends AbstractQuery
{
     ...
     *
     * DELETE /users/[username]/posts/[resourceHash]
     *
     * @param string $userName username whos post is supposed to be deleted
     * @param string $resourceHash interhash of resource
     */
    public function __construct(string $userName, string $resourceHash)
    {
