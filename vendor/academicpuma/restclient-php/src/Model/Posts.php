 ...
 */
class Posts extends ArrayList implements ModelObject
{
    ...
    /**
     * @param string $sortingKey sorting key
     * @param string $order sorting order (allowed values: asc|desc)
     *
     * @return $this
     */
    public function sort(string $sortingKey, string $order = Sorting::ORDER_ASC): Posts
    {
        $comparator = new PostComparator($sortingKey, $order);
