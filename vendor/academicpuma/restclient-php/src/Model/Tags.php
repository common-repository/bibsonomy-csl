...
use AcademicPuma\RestClient\Util\Collection\TagComparator;
...
class Tags extends ArrayList implements ModelObject
{
     ...
     * @return $this
     */
    public function sort(string $sortingKey, string $order = Sorting::ORDER_ASC): Tags
    {
        $comparator = new TagComparator($sortingKey, $order);
