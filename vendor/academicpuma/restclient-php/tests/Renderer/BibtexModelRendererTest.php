 ...
 */
class BibtexModelRendererTest extends TestCase
{
    ...
    {
        $bibtexRenderer = new BibtexModelRenderer(true);
        $actual = $bibtexRenderer->render($this->resource);
        $expected = TestHelper::loadBibTeX('bibtex.bib');
        print_r($actual);
        echo "\n";
        $this->assertStringStartsWith('@', $actual);
        $this->assertStringEndsWith("}" . BibtexModelRenderer::NEWLINE, $actual);
    ...
    {
        echo "without misc fields\n";
        $bibtexRenderer = new BibtexModelRenderer();
        $actual = $bibtexRenderer->render($this->post);
        print_r($actual);
        echo "\n";
        $this->assertStringStartsWith('@', $actual);
        $this->assertStringEndsWith("}" . BibtexModelRenderer::NEWLINE, $actual);
